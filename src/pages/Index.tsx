...
const services = [
  { icon: 'Leaf', title: 'Классический массаж', text: 'Снимает напряжение, улучшает кровообращение и возвращает телу лёгкость.' },
...
const prices = [
  { name: 'Классический массаж', time: '60 мин', price: '2 500 BYN' },
  { name: 'Расслабляющий массаж', time: '90 мин', price: '3 200 BYN' },
  { name: 'Антицеллюлитный', time: '60 мин', price: '2 800 BYN' },
        ...
        <div className="container grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="order-1 md:order-2">
            ...
            <p className="text-muted-foreground text-lg mb-5">
              Дипломированный массажист с опытом более 20 лет. Я уверена: настоящее здоровье начинается с расслабления и внимания к телу.
            </p>
            <p className="text-muted-foreground text-lg mb-8">
              В работе использую натуральные масла и индивидуальный подход к каждому гостю. Моя цель — чтобы после сеанса вы чувствовали себя обновлённым.
            </p>
      ...
      <section id="contacts" className="py-24">
        <div className="container max-w-3xl text-center">
          ...
          <p className="text-muted-foreground text-lg mb-10">
            Свяжитесь со мной удобным способом — я помогу подобрать подходящую программу.
          </p>
